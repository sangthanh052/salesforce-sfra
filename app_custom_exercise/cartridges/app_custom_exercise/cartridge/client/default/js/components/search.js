...
var minChars = $('input.search-field').data('min-chars');
...
function getSuggestionsWrapper(scope) {
    var header = $('#header');
    if (header.hasClass('einstein-header')) {
        return $(scope).parents('.search-recommendation-container').find('.suggestions-wrapper');
    }
